...
async def _vllm_chat_with_truncation(
    ...
    parsed_completion_messages = load_harmony_encoding(HarmonyEncodingName.HARMONY_GPT_OSS).parse_messages_from_completion_tokens(finished_output.token_ids, Role.ASSISTANT)
